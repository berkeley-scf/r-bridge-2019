% Summer Bridge R, Module 4: Calculations
...
You could of course write your own *sort* function that uses `order()`. More in Module 5. And in Module 6 we'll see how to do it the "tidyverse" way.
