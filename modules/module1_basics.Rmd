% Summer Bridge R, Module 1: Basics
...
## if the result is not the 'modules' subdirectory of the R part of the Bridge
## directory, set the working directly along the lines of this (on a Mac):
##
## setwd('/Users/paciorek/Desktop/r-bridge-2019/modules')
##
...
## setwd('C:\\Users\\sarah\\r-bridge-2019\\modules')
##
