% Summer Bridge R, Module 0: Introduction
...
The GitHub site ([https://github.com/berkeley-scf/r-bridge-2019](https://github.com/berkeley-scf/r-bridge-2019)) is the main site for the R portion of the Program. It has information on logistics, software installation, and is the master repository for materials for the modules.
...
# Suggestions on how to get the most out of the R part of the Bridge
...
Unless you're already familiar with Git, simply download a zip file with all the material from [https://github.com/berkeley-scf/r-bridge-2019/archive/master.zip](https://github.com/berkeley-scf/r-bridge-2019/archive/master.zip).

## Within RStudio (via Git)

Within RStudio go to File->New Project->Version Control->Git and enter:

- "Repository URL": https://github.com/berkeley-scf/r-bridge-2019
- "Project Directory Name": r-bridge-2019 (or something else of your choosing)
...
## From a Mac/Linux terminal window (via Git)

Run the following commands:

- `cd /directory/where/you/want/repository/located`
- `git clone https://github.com/berkeley-scf/r-bridge-2019`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/r-bridge-2019`
- `git pull`
...
- Some of this material was drawn from [Jared Knowles Summer Bridge R](http://jaredknowles.com/r-R part of the Bridge/url).
