...
% Chris Paciorek (built off of material by Kellie Ottoboni and Chris Krogslund)
...
* Three main toolkits for producing graphics in R: **base**, **`ggplot2`**, and **`lattice`**
* In practice, these are grouped into two camps: "basic" and "advanced"
