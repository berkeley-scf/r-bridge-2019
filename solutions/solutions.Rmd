% Summer Bridge R, Breakout Solutions
...
## Unless we figure out some way to make sure points are overlaid from largest to smallest. Let's try 'arranging' from largest to smallest.
## And using some hints found online: https://stackoverflow.com/questions/19506630/control-point-border-thickness-in-ggplot)
